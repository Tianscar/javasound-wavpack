...
public class WavpackUtils
{
    ...
    static final long[] sample_rates =
    {
    ...
    public static WavpackContext WavpackOpenFileInput(java.io.DataInputStream infile)
    {
        ...
        while (wps.wphdr.block_samples == 0)
        {
            ...
            {
                wpc.error_message = new WavpackException("not compatible with this version of WavPack file!");
                wpc.error = true;
                return (wpc);
            }
    ...
    {
        return wpc.error_message.getMessage();
    }
    ...
    public static int WavpackSetConfiguration(WavpackContext wpc, WavpackConfig config, long total_samples)
    {
        ...
        {
            wpc.error_message = new WavpackException("too many channels!");
    ...
    static int finish_block(WavpackContext wpc)
    {
        ...
        if (result == 0)
        {
            wpc.error_message = new java.io.IOException("output buffer overflowed!");
        ...
        if (result == 0)
        {
            wpc.error_message = new java.io.IOException("can't write WavPack data, disk probably full!");
    ...
    public static void WavpackCloseFile(WavpackContext wpc)
    {
        if (null != wpc.infile)
        {
            try
